...
function SetUpLoader(text, verison, callback)
	...
	Status_2.Text = "Loaded " .. verison .. " Verison"
	...
	GameImageLabel.Image = "https://www.roblox.com/asset-thumbnail/image?assetId=" .. tostring(game.PlaceId) .. "&width=420&height=420&format=png"
	...
	load.MouseButton1Click:Connect(function()
	    ...
	    local LoaderUI = CoreGui:FindFirstChild("Loader")
	    if LoaderUI then
	        LoaderUI:Destroy()
	    end
	end)
...
if Whitelists[game:GetService("Players").LocalPlayer.UserId] then
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "[Tipware.lua] Whitelist",
        Text = "You're whitelisted, Loading Loader.",
        Duration = 5.5,
    })
    print("[Tipware.lua]: You're Whitelisted, Loading Loader.")
    print("[Tipware.lua]: Finishing Items.")
    print("[Tipware.lua]: Completed.")
    
    SetUpLoader("tipware.lua", "Aimbot", function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/liquidcheats/tipware/main/Main/Offical%20Tipware%20Lib.lua"))()
    end)
else
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "[Tipware.lua] Whitelist",
        Text = "You aren't whitelisted lmao.",
        Duration = 5.5,
    })
end
