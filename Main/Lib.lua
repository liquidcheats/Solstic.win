...
local cfglocation = "nyula/configs/"
if not isfolder("nyula") then
    makefolder("nyula")
end
if not isfolder("nyula/configs") then
    makefolder("nyula/configs")
end
if not isfolder("nyula/luas") then
    makefolder("nyula/luas")
end
			...
			function MSector:Tab(text)
				...
				function tab:Element(type, text, data, callback)
					...
					elseif type == "Toggle" then
						...
						local function update()
							if Element.value.Toggle then
								tween = library:Tween(Color, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = COL3RGB(235, 152, 177)})
								library:Tween(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(255, 255, 255)})
							else
					...
					elseif type == "ToggleColor" then
						...
						local function update()
							if Element.value.Toggle then
								tween = library:Tween(Color, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(119, 0, 255)})
