...
function API:Draw(shape, visible, pos, text)
    if shape == "Square" or shape == "square" then
        ...
        square.Position = pos or Vector2.new(100, 100)
    ...
    elseif shape == "Line" or shape == "line" then
        ...
        line.From = pos or Vector2.new(0, 0)
    ...
    elseif shape == "Circle" or shape == "circle" then
        ...
        circle.Position = pos or Vector2.new(150, 150)
        circle.Radius = 100
    ...
    elseif shape == "Triangle" or shape == "triangle" then
        ...
        triangle.PointA = pos or Vector2.new(100, 100)
